...
import userImg from "../../../assets/img/portrait/small/camil.jpg"

const UserDropdown = props => {
  return (
    <DropdownMenu right>
      <DropdownItem tag="a" href="#" className="hidden">
  ...
  render() {
    return (
      <ul className="nav navbar-nav navbar-nav-user float-right">
        ...
        >
          <DropdownToggle tag="a" className="nav-link nav-link-label hidden">
            <Icon.Bell size={21} />
        ...
        <UncontrolledDropdown tag="li" className="dropdown-user nav-item">
          <DropdownToggle tag="a" className="nav-link dropdown-user-link">
            <div className="user-nav d-sm-flex d-none">
              ...
              <span className="user-status hidden">Available</span>
            </div>
            <span data-tour="user">
              <img
                src={userImg}
